...
3. Add the same env vars from `.env.local`. Set `NEXT_PUBLIC_APP_URL` to your live URL, for example `https://www.jobdraftly.com`.
...
- Add `https://www.jobdraftly.com/auth/callback` to **Redirect URLs**.
